...
c       EXTERNAL MPI_DUP_FN, MPI_NULL_DELETE_FN, MPI_NULL_COPY_FN
c       EXTERNAL MPI_WTIME, MPI_WTICK
c       EXTERNAL PMPI_WTIME, PMPI_WTICK
c       EXTERNAL MPI_COMM_DUP_FN, MPI_COMM_NULL_DELETE_FN
c       EXTERNAL MPI_COMM_NULL_COPY_FN
c       EXTERNAL MPI_WIN_DUP_FN, MPI_WIN_NULL_DELETE_FN
c       EXTERNAL MPI_WIN_NULL_COPY_FN
c       EXTERNAL MPI_TYPE_DUP_FN, MPI_TYPE_NULL_DELETE_FN
c       EXTERNAL MPI_TYPE_NULL_COPY_FN
c       EXTERNAL MPI_CONVERSION_FN_NULL
c       DOUBLE PRECISION MPI_WTIME, MPI_WTICK
c       DOUBLE PRECISION PMPI_WTIME, PMPI_WTICK


c       COMMON /MPIPRIV1/ MPI_BOTTOM, MPI_IN_PLACE, MPI_STATUS_IGNORE

c       COMMON /MPIPRIV2/ MPI_STATUSES_IGNORE, MPI_ERRCODES_IGNORE
c       SAVE /MPIPRIV1/,/MPIPRIV2/

c       COMMON /MPIPRIVC/ MPI_ARGVS_NULL, MPI_ARGV_NULL
c       SAVE   /MPIPRIVC/
